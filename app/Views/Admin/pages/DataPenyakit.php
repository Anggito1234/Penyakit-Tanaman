            ...
            <div id="layoutSidenav_content">
                <main>
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <table id="datatablesSimple">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td><?= $p['KodePenyakit']; ?></td>
                                            <td><?= $p['NamaPenyakit']; ?></td>
                                            <td><button class="btn btn-info"  data-bs-toggle="modal" data-bs-target="#editPenyakit-<?= $p['KodePenyakit']; ?>">Edit</button>
                                        <a class="btn btn-danger" href="/dashboard/hapusPenyakit/<?= $p['KodePenyakit']; ?>">Hapus</a></td>
                                        </tr>
                                    </tbody>
                                    <!-- Modal Edit Pertanyaan -->
                                        <div class="modal fade" id="editPenyakit-<?= $p['KodePenyakit']?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                        <div class="modal-dialog modal-dialog-scrollable">
                                            ...
                                            <form action="/dashboard/editPenyakit" method="post" enctype="multipart/form-data">
                                            <div class="mb-3">
                                                <label for="exampleInputEmail1" class="form-label">Nama Penyakit</label>
                                                <input type="text" value="<?= $p['NamaPenyakit']?>" name="NamaPenyakit" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
                                                <input type="text" hidden value="<?= $p['KodePenyakit']?>" name="KodePenyakit" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
                                            </div>
                                            </div>
                    ...
                    <div class="modal-dialog modal-dialog-scrollable">
                        ...
                        <div class="modal-body">
                        <form action="/dashboard/tambahPenyakit" method="post" enctype="multipart/form-data">
                        <div class="mb-3">
                            <label for="exampleInputEmail1" class="form-label">Kode Penyakit</label>
                            <input type="text" name="KodePenyakit" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
                        </div>
                        <div class="mb-3">
                            <label for="exampleInputEmail1" class="form-label">Nama Penyakit</label>
                            <textarea type="text" name="NamaPenyakit" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp"></textarea>
                        </div>
                        </div>
                        <div class="modal-footer">
                            <button type="submit" class="btn btn-primary">Simpan</button>
